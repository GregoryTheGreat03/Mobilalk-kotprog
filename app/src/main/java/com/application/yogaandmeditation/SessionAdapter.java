...
public class SessionAdapter extends RecyclerView.Adapter<SessionAdapter.ViewHolder> implements Filterable {
    private ArrayList<OnlineSession> mOnlineSessionData;
    private ArrayList<OnlineSession> mOnlineSessionDataAll;
    private Context mContext;
    private int lastPosition = -1;

    SessionAdapter(Context context, ArrayList<OnlineSession> sessionData){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.list_session, parent, false));
    }
